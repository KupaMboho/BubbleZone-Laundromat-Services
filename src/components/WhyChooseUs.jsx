    ...
    <section className="py-20 bg-sky-light">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <span className="text-accent font-accent font-semibold text-sm uppercase tracking-wider">Why Choose Us</span>
              ...
              {reasons.map((reason, index) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center flex-shrink-0">
                    <reason.icon className="text-accent text-lg" />
                  </div>
                  <div>
                    <h3 className="font-heading font-bold text-primary-dark">{reason.title}</h3>
                    <p className="text-text-light text-sm font-body">{reason.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
